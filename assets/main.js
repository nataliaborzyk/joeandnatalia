...
const TRANSLATIONS = {
  pl: {
    ...
    travel_hotel2_body: 'Kameralny, butikowy hotel usytuowany zaledwie kilka kilometrów od Zaczarowanej Furmanki — świetny wybór dla tych, którzy wolą bliskość miejsca wesela i nie mają w planach zwiedzania Krakowa. Wynegocjowaliśmy dla Was 15% zniżki przy rezerwacji bezpośrednio przez stronę hotelu z kodem NJ2027.',
  ...
  en: {
    ...
    travel_hotel1_url: 'https://www.hotel-wyspianski.pl/',
    travel_hotel2_title: 'Hotel Zameczek, Książ Wielki',
    travel_hotel2_body: 'A cozy, boutique hotel located just a few kilometers from Zaczarowana Furmanka — a great choice for those who want to stay close to the venue and aren\'t planning to explore Kraków. We\'ve negotiated a 15% discount for you when booking directly through the hotel\'s website with the code NJ2027.',
