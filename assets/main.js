...
const TRANSLATIONS = {
  pl: {
    ...
    travel_hotel1_body: 'Idealna opcja dla tych, którzy chcą przy okazji zwiedzić Kraków — hotel leży w samym centrum miasta, kilka minut spacerem od Rynku Głównego. Wynegocjowaliśmy dla Was 10% zniżki przy rezerwacji bezpośrednio przez stronę hotelu z kodem NJ2027.',
  ...
  en: {
    ...
    travel_hotel1_title: 'Hotel Wyspiański, Kraków',
    travel_hotel1_body: 'The perfect choice for those who want to explore Kraków — the hotel is right in the city centre, just a few minutes\' walk from the Main Market Square. We\'ve secured a 10% discount for our guests when booking directly through the hotel\'s website using the code NJ2027.',
    travel_hotel1_url: 'https://www.hotel-wyspianski.pl/',
    travel_hotel2_title: 'Hotel Zameczek, Książ Wielki',
