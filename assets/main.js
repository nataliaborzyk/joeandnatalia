...
const TRANSLATIONS = {
  pl: {
    ...
    venue_map_title: 'Odkryj naszą przestrzeń',
    // travel
    travel_eyebrow: 'Noclegi i transport',
    travel_title: 'Zostań z nami dłużej',
    travel_hotel1_title: 'Hotel Wyspiański, Kraków',
    travel_hotel1_body: 'Idealna opcja dla tych, którzy chcą przy okazji zwiedzić Kraków — hotel leży w samym centrum miasta, kilka minut spacerem od Rynku Głównego. Wynegocjowaliśmy dla Was 10% zniżki przy rezerwacji bezpośrednio przez stronę hotelu z kodem.',
    travel_hotel1_url: 'https://www.hotel-wyspianski.pl/',
    travel_hotel2_title: 'Hotel Zameczek, Książ Wielki',
    travel_hotel2_body: 'Kameralny, butikowy hotel usytuowany zaledwie kilka kilometrów od Zaczarowanej Furmanki — świetny wybór dla tych, którzy wolą bliskość miejsca wesela i nie mają w planach zwiedzania Krakowa. Wynegocjowaliśmy dla Was 15% zniżki przy rezerwacji bezpośrednio przez stronę hotelu z kodem.',
  ...
  en: {
    ...
    venue_map_title: 'Explore our space',
    // travel
    travel_eyebrow: 'Accommodation & transport',
    travel_title: 'Stay a little longer',
    travel_hotel1_title: 'Hotel Wyspiański, Kraków',
    travel_hotel1_body: 'The perfect choice for those who want to explore Kraków — the hotel is right in the city centre, just a few minutes\' walk from the Main Market Square. We\'ve secured a 10% discount for our guests when booking directly through the hotel\'s website using the code.',
    travel_hotel1_url: 'https://www.hotel-wyspianski.pl/',
    travel_hotel2_title: 'Hotel Zameczek, Książ Wielki',
