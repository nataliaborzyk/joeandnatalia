...
const TRANSLATIONS = {
  pl: {
    ...
    travel_hotel1_title: 'Hotel Wyspiański, Kraków',
    travel_hotel1_body: 'Kameralny, butikowy hotel usytuowany zaledwie kilka kilometrów od Zaczarowanej Furmanki - świetny wybór dla tych, którzy wolą bliskość miejsca wesela i nie mają w planach zwiedzania Krakowa. Wynegocjowaliśmy dla Was 15% zniżki przy rezerwacji bezpośrednio przez stronę hotelu z kodem NJ2027.',
    travel_hotel1_url: 'https://www.hotel-wyspianski.pl/',
    travel_hotel2_title: 'Hotel Zameczek, Książ Wielki',
    travel_hotel2_body: 'Kameralny, butikowy hotel w historycznym pałacu, zaledwie kilka kilometrów od Zaczarowanej Furmanki — świetny wybór dla tych, którzy wolą spokój i bliskość miejsca wesela zamiast centrum miasta. Wynegocjowaliśmy dla Was 15% zniżki przy rezerwacji bezpośrednio przez stronę hotelu z kodem NJ2027.',
    ...
    faq_q5: 'Co z noclegiem dla gości spoza Krakowa?',
    faq_a5: 'Dla gości potrzebujących noclegu wynegocjowaliśmy świetne ceny w okolicznych hotelach i pensjonatach. Dodatkowo organizujemy transport autokarowy z miejsca wesela do noclegów, żebyście nie musieli martwić się o powrót. Wszystkie szczegóły znajdziesz w zakładce Noclegi i transport.',
  ...
  en: {
    ...
    travel_hotel1_title: 'Hotel Wyspiański, Kraków',
    travel_hotel1_body: 'A cozy, boutique hotel located just a few kilometers from Zaczarowana Furmanka — a great choice for those who want to stay close to the venue and aren\'t planning to explore Kraków. We\'ve negotiated a 15% discount for you when booking directly through the hotel\'s website with the code NJ2027.',
    travel_hotel1_url: 'https://www.hotel-wyspianski.pl/',
    travel_hotel2_title: 'Hotel Zameczek, Książ Wielki',
    travel_hotel2_body: 'A charming boutique hotel in a historic palace, just a few kilometres from Zaczarowana Furmanka — a great option for those who prefer peace and quiet and staying close to the venue rather than the city. We\'ve secured a 15% discount for our guests when booking directly through the hotel\'s website using the code NJ2027.',
    travel_hotel2_url: 'https://www.hotelzameczek.pl/',
    travel_bus_title: 'Transport',
    travel_bus_body: 'We\'re organising a coach to take guests from the venue to both hotels after the reception. We\'ll share the exact timings closer to the date. If you\'d like to use the transport, please let us know in the RSVP form.',
    // faq
    ...
    faq_a5: 'For guests who need a place to stay, we\'ve negotiated great rates at nearby hotels and guesthouses. We\'re also organising a coach from the venue to the accommodation, so you won\'t have to worry about getting back. All the details are on the Stay & Travel page.',
