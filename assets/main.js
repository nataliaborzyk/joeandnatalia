...
const TRANSLATIONS = {
  pl: {
    ...
    venue_intro: 'Zapraszamy Was do wyjątkowego miejsca — stodoły pełnej magii, historii i ciepła. Zaczarowana Furmanka to rustykalny zakątek na Mazowszu, otoczony naturą, gdzie czas zwalnia, a każda chwila nabiera znaczenia.',
    venue_barn_title: 'O stodole',
    venue_barn_body: 'Stodoła z XVIII-wieczną duszą i nowoczesnym komfortem. Drewniane belki, ceglane mury i wieczorne światło świec — to przestrzeń, która opowiada własną historię. Pojemność: do 120 gości.',
    venue_dress_title: 'Dress code',
    venue_dress_body: 'Zależy nam na klimacie wieczoru — prosimy o eleganckię, ale komfortowy strój w odcieniach natury: zieleń, beż, ecru, miodowy, burgundy. Panie — ze względu na trawnik i kocią łapę, warto rozważyć płaskie lub stabilne obcasy.',
    venue_expect_title: 'Czego się spodziewać',
    venue_expect_body: 'Ceremonia plenerowa w ogrodzie, przyjęcie w stodole, żywa muzyka do późna. W ciągu wieczoru przewidziane są przerwy na świeże powietrze i spacer po terenie posiadłości. Przygotujcie się na magię.',
    venue_address_title: 'Dojazd',
    venue_address_body: 'Zaczarowana Furmanka, ul. Przykładowa 12, 05-123 Miejscowość. Współrzędne GPS: 52.1234, 21.5678. Parking dostępny na miejscu.',
    // travel
    ...
    faq_a1: 'Wesele jest imprezą dla dorosłych — prosimy o zapewnienie opieki dla najmłodszych. Wyjątek stanowią niemowlęta do 12 miesiąca życia.',
  ...
  en: {
    ...
    venue_title: 'Zaczarowana Furmanka',
    venue_intro: 'We invite you to a truly magical place — a barn full of warmth, history, and charm. Zaczarowana Furmanka is a rustic retreat in Mazovia, surrounded by nature, where time slows down and every moment feels meaningful.',
    venue_barn_title: 'About the barn',
    venue_barn_body: 'An 18th-century soul with modern comfort. Wooden beams, brick walls, and candlelight — a space that tells its own story. Capacity: up to 120 guests.',
    venue_dress_title: 'Dress code',
    venue_dress_body: 'We would love for you to join us in elegant yet comfortable attire in nature\'s tones: forest green, beige, ecru, honey, or burgundy. Ladies — given the garden lawn, we suggest flat or block-heeled shoes.',
    venue_expect_title: 'What to expect',
    venue_expect_body: 'An outdoor ceremony in the garden, reception in the barn, and live music until late. Throughout the evening there will be time to step outside and explore the estate. Prepare to be enchanted.',
    venue_address_title: 'Getting there',
    venue_address_body: 'Zaczarowana Furmanka, ul. Przykładowa 12, 05-123 Miejscowość, Poland. GPS: 52.1234, 21.5678. Free parking available on site.',
    // travel
    ...
    faq_a1: 'The wedding is an adults-only event — please arrange childcare for little ones. Babies under 12 months are of course welcome.',
